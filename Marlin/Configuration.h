...
#define DELTA_DIAGONAL_ROD 150.0 // mm            // Was 240.0 mm
                                                  // V2 of 3DR = 153mm rods

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 114.3 // mm         // For 3DR Version 2 - this number was lowered a little - to stop the hotend diging into the model.
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 175.25  //  10.00
    #define  DEFAULT_bedKi  33.43  //    .023
    #define  DEFAULT_bedKd 229.71  // 305.4
...
#define MANUAL_Z_HOME_POS 206.17
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {54.52, 54.52, 54.52, 278}
#define DEFAULT_MAX_FEEDRATE          {500, 500, 500, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {400, 400, 400, 380}    // X, Y, Z, E maximum start speed for accelerated moves.
